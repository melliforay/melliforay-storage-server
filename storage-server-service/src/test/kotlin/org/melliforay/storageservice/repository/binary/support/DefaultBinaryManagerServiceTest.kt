...
import org.melliforay.storageservice.repository.internal.support.DefaultBinaryManagerService
...
class DefaultBinaryManagerServiceTest {
    ...
    fun testWriteUniqueFile() {
        ...
        val permanentPath = managerService.createFile(stream)
    ...
    fun testDeduplicateOnMatchingHash() {
        ...
        val retPath = managerService.createFile(stream)
    ...
    fun testDeduplicateOnMatchingHashDifferentSize() {
        ...
        managerService.createFile(stream)
